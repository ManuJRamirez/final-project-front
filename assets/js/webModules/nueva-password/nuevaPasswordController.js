...
export const nuevaPasswordController = (nuevaPasswordFormData) => {
    ...
    const nuevaPasswordInput = nuevaPasswordFormData.querySelector('#nuevaPassword'); 
    const repitePasswordInput = nuevaPasswordFormData.querySelector('#repitePassword');
    ...
    nuevaPasswordInput.addEventListener('input', function(event) {
        ...
        if (!nuevaPasswordInput.validity.valid && (!errorMessage || errorMessage.style.display === 'none')) {
